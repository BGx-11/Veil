    ...
    <div className="shell">
      ...
      <div className="toolbar" style={{ position: 'relative', zIndex: 100 }}>
        ...
        <div className="toolbar-actions" style={{ position: 'relative' }} onClick={e => e.stopPropagation()}>
          ...
          {moreMenuOpen && (
            <div style={{ position: 'absolute', top: '100%', right: '0', marginTop: '8px', background: 'rgba(20, 20, 20, 0.85)', backdropFilter: 'blur(20px)', borderRadius: '12px', border: '1px solid var(--border)', padding: '8px', width: '200px', zIndex: 100, display: 'flex', flexDirection: 'column', gap: '4px', boxShadow: '0 10px 30px rgba(0,0,0,0.5)' }}>
